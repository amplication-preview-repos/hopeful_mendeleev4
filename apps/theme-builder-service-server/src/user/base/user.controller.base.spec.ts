...
const CREATE_INPUT = {
  ...
  uniqueEmailAddress: "exampleUniqueEmailAddress",
  uniqueFirstName: "exampleUniqueFirstName",
  uniqueLastName: "exampleUniqueLastName",
  uniqueUsername: "exampleUniqueUsername",
  uniqueUserPassword: "exampleUniqueUserPassword",
  updatedAt: new Date(),
